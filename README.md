...
In short: you can use, modify and distribute the code, but you must follow the three pillars of BTG in any derivative works.
...
· Follow the three pillars of BTG
· Pass all tests
...
BTG: high speed, startup under 2 seconds, full modularity, absolute stability, engineering ideology.
...
GNU for showing the importance of freedom. We went further.

---

BTG — freedom to choose better
